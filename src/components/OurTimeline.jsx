...
const OurTimeline = () => {
    return (
        <section id="timeline" className="max-w-6xl mx-auto px-4 md:px-8 py-20 bg-white">
            <FadeIn className="text-center mb-16">
                <h2 className="text-5xl md:text-6xl font-ballet text-navy mb-4">Our Timeline</h2>
