...
const ChildrenSection = ({
  ...
  <div className="mt-6 p-6 bg-white/10 rounded-xl border border-white/20">
    <h4 className={`${language === 'th' ? 'font-krub' : 'font-source-serif'} font-[400] text-xl text-white mb-4`}>{language === 'th' ? "เด็ก (Children)" : "Children"}</h4>
    <div className="space-y-3 mb-4">
      <label className="flex items-center gap-3 cursor-pointer" onClick={() => onHasChildrenChange('yes')}>
        ...
        <span className={`text-white/90 ${language === 'th' ? 'font-krub' : 'font-source-serif'} font-[400]`}>{language === 'th' ? "มี" : "Yes"}</span>
      </label>
      <label className="flex items-center gap-3 cursor-pointer" onClick={() => onHasChildrenChange('no')}>
        ...
        <span className={`text-white/90 ${language === 'th' ? 'font-krub' : 'font-source-serif'} font-[400]`}>{language === 'th' ? "ไม่มี" : "No"}</span>
      </label>
    </div>
