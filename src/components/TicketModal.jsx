                                                ...
                                                {data?.waitGroupRate === 'yes' && (
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <div className="leading-snug">
                                                            ...
                                                            <p className="mb-1">{language === 'th' ? "จำนวนห้อง: " : "Rooms: "}{data?.rooms}</p>
                                                            {data?.stayType === 'sharing' && (
                                                                <p className="mb-1">{language === 'th' ? "แชร์ห้องกับ: " : "Share room with: "}{data?.isShareNotSure ? (language === 'th' ? 'ยังไม่แน่ใจ' : 'Not sure yet') : data?.shareWith}</p>
                                                            )}
